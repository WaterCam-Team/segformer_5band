...
def parse_args():
    ...
    parser.add_argument('--checkpoint', help='checkpoint file',default='/data1/huantao/workspace/project/flood_seg/SegFormer/work_dirs/segformer.b0.512x512.flood_5band_2cls.65k/iter_100.pth')
    parser.add_argument(
    ...
    parser.add_argument(
        '--show-dir', help='directory where painted images will be saved',default='/data1/huantao/workspace/project/flood_seg/SegFormer/result')
    parser.add_argument(
        '--gpu-collect',
        action='store_true',
...
def main():
    ...
    # model.CLASSES = ('building','water','vehicle', 'people','plants','sky')
    # model.PALETTE = [[250,50,83],[51,221,255],[255,96,55],[92,179,162],[102,255,102], [61,61,245]]
