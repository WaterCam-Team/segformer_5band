...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='/data1/huantao/workspace/project/flood_seg/dataset/my_5band_data/img_dir',
        ann_dir='/data1/huantao/workspace/project/flood_seg/dataset/my_5band_data/ann_dir',
        pipeline=test_pipeline))
