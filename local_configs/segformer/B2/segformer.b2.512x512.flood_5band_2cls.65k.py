...
train_pipeline = [
    ...
    dict(type='Normalize_5band', **img_norm_cfg),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            img_dir='fiveband/img_dir/train',
            ann_dir='fiveband/ann_dir/train',
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='fiveband/img_dir/val',
        ann_dir='fiveband/ann_dir/val',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='fiveband/img_dir/test',
        ann_dir='fiveband/ann_dir/test',
        pipeline=test_pipeline))
