...
dataset_type = 'dataset_rgb_std'
data_root = 'data/modality_comparison/'

# REPLACE with values from: python tools/compute_band_stats.py --modality rgb_std
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            img_dir='rgb_std/img_dir/train',
            ann_dir='rgb_std/ann_dir/train',
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='rgb_std/img_dir/val',
        ann_dir='rgb_std/ann_dir/val',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='rgb_std/img_dir/test',
        ann_dir='rgb_std/ann_dir/test',
        pipeline=test_pipeline))
